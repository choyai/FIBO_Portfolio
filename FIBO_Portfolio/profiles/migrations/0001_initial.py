# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-11-30 06:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to=profiles.models.activity_dir_path, verbose_name='Activity Picture')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('stID', models.CharField(blank=True, max_length=20)),
                ('banner', models.ImageField(blank=True, upload_to=profiles.models.user_dir_path, verbose_name='Banner')),
                ('avatar', models.ImageField(blank=True, upload_to=profiles.models.user_dir_path, verbose_name='Profile Picture')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('activity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='profiles.Activity')),
                ('supervisor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='profiles.Profile')),
            ],
        ),
        migrations.CreateModel(
            name='UserImage',
        ...
        migrations.AddField(
            model_name='activity',
            name='supervisors',
            field=models.ManyToManyField(related_name='supervisor', through='profiles.Supervision', to='profiles.Profile'),
        ),
        migrations.AddField(
            model_name='ability',
            name='profile',
