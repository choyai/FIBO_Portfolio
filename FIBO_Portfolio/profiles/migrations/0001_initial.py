# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-11-30 02:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('avatar', models.ImageField(upload_to=profiles.models.user_dir_path, verbose_name=b'Profile Picture')),
                ('bio', models.TextField(blank=True, max_length=500)),
                ('birthDate', models.DateField(blank=True, null=True)),
                ('location', models.CharField(blank=True, max_length=255)),
                ('phone', models.CharField(blank=True, max_length=50)),
                ('emergencyPhone', models.CharField(default=b'-', max_length=50)),
                ('congenitalDisease', models.CharField(default=b'None', max_length=50)),
                ('emailConfirmed', models.BooleanField(default=False)),
                ('account_type', models.CharField(choices=[(b'ST', b'Student'), (b'LE', b'Lecturer'), (b'SF', b'Staff')], default=b'Student', max_length=100)),
                ('position', models.CharField(max_length=100)),
                ('admission', models.CharField(blank=True, max_length=100)),
                ('scholarship', models.CharField(default=b'None', max_length=100)),
